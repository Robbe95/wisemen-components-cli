...
export const COMPONENTS_DIR = "./modules/ui/components"
export const UTILS_LOCATION = "@/modules/ui/utils"
export const COMPONENT_ALIAS = "@/modules/ui/components/"
 ...
 */
const explorer = cosmiconfig("wisemen-ui")
